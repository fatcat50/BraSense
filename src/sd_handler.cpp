...
void createNewMeasurementFile()
{
    ...
    {
        Serial.println("Fehler beim Abrufen der Zeit! Verwende Standard-Dateinamen.");
        char filename[32];
        sprintf(filename, "/messung_%04u.txt", fileCounter); // Fallback, falls Zeit nicht verfügbar
